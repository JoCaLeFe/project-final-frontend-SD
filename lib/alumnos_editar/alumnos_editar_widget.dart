...
import 'alumnos_editar_model.dart';
export 'alumnos_editar_model.dart';

class AlumnosEditarWidget extends StatefulWidget {
  const AlumnosEditarWidget({
    super.key,
  ...
  static String routeName = 'AlumnosEditar';
  static String routePath = '/alumnosEditar';

  @override
  State<AlumnosEditarWidget> createState() => _AlumnosEditarWidgetState();
}

class _AlumnosEditarWidgetState extends State<AlumnosEditarWidget> {
  late AlumnosEditarModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AlumnosEditarModel());

    _model.matriculaTextController ??=
        TextEditingController(text: widget.matricula);
                      ...
                      children: [
                        ...
                        FFButtonWidget(
                          onPressed: () async {
                            ...
                            _model.actualizarAlumnoOutput =
                                await UpdateStudentCall.call(
                              id: widget.id,
                            ...
                            if ((_model.actualizarAlumnoOutput?.succeeded ??
                                true)) {
                              context.goNamed(AlumnosWidget.routeName);
                            }
