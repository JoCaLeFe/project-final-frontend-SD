...
import '/index.dart';
import 'alumnos_editar_widget.dart' show AlumnosEditarWidget;
import 'package:flutter/material.dart';

class AlumnosEditarModel extends FlutterFlowModel<AlumnosEditarWidget> {
  ...
  // Stores action output result for [Backend Call - API (UpdateStudent)] action in Button widget.
  ApiCallResponse? actualizarAlumnoOutput;
