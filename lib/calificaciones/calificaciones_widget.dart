                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        FFButtonWidget(
                          onPressed: () async {
                            context.goNamed(
                                CalificacionesRegistroWidget.routeName);
                          },
                  ...
                  Padding(
                    ...
                    child: FutureBuilder<ApiCallResponse>(
                      ...
                      builder: (context, snapshot) {
                        ...
                        final containerGetAllGradesResponse = snapshot.data!;
                        ...
                        return Container(
                          ...
                          child: Builder(
                            builder: (context) {
                              final tabla = containerGetAllGradesResponse
                                  .jsonBody
                                  .toList();
                                        ...
                                        children: [
                                          Align(
                                            ...
                                            child: FlutterFlowIconButton(
                                              ...
                                              onPressed: () async {
                                                context.goNamed(
                                                  CalificacionesEditarWidget
                                                      .routeName,
                                                  queryParameters: {
                                                    'idAlumno': serializeParam(
                                                      getJsonField(
                                                        tablaItem,
                                                        r'''$.student.id''',
                                                      ).toString(),
                                              ...
                                              onPressed: () async {
                                                ...
                                                if ((_model.deleteStudentOutput
                                                  ...
                                                  ScaffoldMessenger.of(context)
                                                    ...
                                                    SnackBar(
                                                      content: Text(
                                                        'Calificación Eliminada: ${getJsonField(
                                                          tablaItem,
                                                          r'''$.score''',
                                                        ).toString()} | Alumno: ${getJsonField(
                                                          tablaItem,
                                                          r'''$.student.name''',
                                                        ).toString()} | Asignatura: ${getJsonField(
                                                          tablaItem,
                                                          r'''$.subject.name''',
                                                        ).toString()}',
                                                        style: TextStyle(
