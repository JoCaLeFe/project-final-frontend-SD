...
import '/index.dart';
import 'calificaciones_registro_widget.dart' show CalificacionesRegistroWidget;
import 'package:flutter/material.dart';

class CalificacionesRegistroModel
    extends FlutterFlowModel<CalificacionesRegistroWidget> {
  ...
  // Stores action output result for [Backend Call - API (CreateGrade)] action in Button widget.
  ApiCallResponse? registrarCalificacionOutput;
